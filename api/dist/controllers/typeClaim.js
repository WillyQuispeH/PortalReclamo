...
const TypeClaimModels = __importStar(require("../models/typeClaim"));
const logger_1 = __importDefault(require("../utils/logger"));
const getAll = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const result = yield TypeClaimModels.getAll();
        if (!result.success) {
...
const create = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const result = yield TypeClaimModels.create(typename);
        if (!result.success) {
            logger_1.default.error({
...
const update = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const result = yield TypeClaimModels.update(id, typename);
        if (!result.success) {
            logger_1.default.error({
...
const remove = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { id } = req.body;
        const result = yield TypeClaimModels.remove(id);
        if (!result.success) {
            logger_1.default.error({
